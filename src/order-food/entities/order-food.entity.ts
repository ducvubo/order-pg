...
export class OrderFoodEntity extends SampleEntity {
  ...
  */
  @Column('varchar', { length: 255 })
  od_status?: "waiting_confirm_customer" | "over_time_customer" | "waiting_confirm_restaurant" | "waiting_shipping" | "shipping" | "delivered_customer" | "received_customer" | "cancel_customer" | "cancel_restaurant" | "complaint" | "complaint_done"
